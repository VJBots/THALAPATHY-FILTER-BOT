...
URL = "https://filterboto.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filterboto.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filterboto.herokuapp.com/".format(FQDN)
else:
    URL = "https://filterboto.herokuapp.com/".format(FQDN)
