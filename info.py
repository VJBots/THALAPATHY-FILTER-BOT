...
URL = "https://urlshortautofilterbot-vijayaman358.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://urlshortautofilterbot-vijayaman358.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://urlshortautofilterbot-vijayaman358.koyeb.app/".format(FQDN)
else:
    URL = "https://urlshortautofilterbot-vijayaman358.koyeb.app/".format(FQDN)
