...
URL = "https://vjthalapathy-61eddb38a62d.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vjthalapathy-61eddb38a62d.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vjthalapathy-61eddb38a62d.herokuapp.com/".format(FQDN)
else:
    URL = "https://vjthalapathy-61eddb38a62d.herokuapp.com/".format(FQDN)
